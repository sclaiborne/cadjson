...
export_step(part, "out/smoke.step")
export_stl(part, "out/smoke.stl", tolerance=0.01, angular_tolerance=0.1)
for name, vp, up in [("top",(0,0,1),(0,1,0)), ("front",(0,-1,0),(0,0,1)), ("side",(1,0,0),(0,0,1)), ("iso",(1,-1,1),(0,0,1))]:
    ...
    ex.write(f"out/smoke_view_{name}.svg")
dx=ExportDXF(); dx.add_layer("vis"); dx.add_shape(part.project_to_viewport((0,0,1))[0], layer="vis"); dx.write("out/smoke_view_top.dxf")
